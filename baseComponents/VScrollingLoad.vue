<template>
  <section class="text-center mt-2" id="scrolling-load">
    <!-- 
    ...
    <template v-if="isLoading">
      <v-icon class="mdi-spin loading-icon text-primary">mdi-loading</v-icon>
      <p class="mb-0 text-primary">Loading more products...</p>
    </template>
